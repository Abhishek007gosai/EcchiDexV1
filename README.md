...
- **Season auto-linking** — setting a join link via the mini app's ➕ editor automatically
...
- Join links are stored as plain URLs you provide via the in-app editor —
  this project doesn't source, scrape, or curate content itself.
